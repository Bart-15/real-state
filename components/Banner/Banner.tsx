        ...
        <div className="container max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2">
                ...
                <div className="p-5 md:mt-10">
                    ...
                    <Link href={props.pageLink} className="btn mt-2 md:text-base bg-slate-300 text-gray-700 font-bold hover hover:bg-slate-700 hover:text-white transition duration-500">{props.buttonTxt}</Link>
                </div>
            </div>
        </div> 
    );
